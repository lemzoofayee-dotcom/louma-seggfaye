...
badge: "Carton 5kg",
image: "iler.webp",
description: "Iler bi (plapla) congelé en carton de 5 kg. Le poisson plat en forme de croissant, celui qui porte le nom de l'outil du cultivateur : une seule arête centrale, une chair fine qui se détache toute seule.",
origine: "Sénégal — Pêche artisanale côtière",
goutPlus: "Son nom vient d'un outil. L'iler, c'est la houe à ailes du cultivateur sénégalais — celle qu'on pousse devant soi pour sarcler le sable — et le poisson en a exactement la forme : large, plat, en croissant. Son nom savant est Drepane africana ; en français on l'appelle le « forgeron ailé » — l'aile, encore. Sur les planches des pêcheurs sénégalais, il est listé sous le nom d'iler geej : l'iler de la mer.",
...
origine: "Sénégal — Pêche artisanale côtière",
goutPlus: "Six poissons dans un seul carton : seude (le barracuda), thiof (le mérou blanc), yakh (la carpe rouge), sompate (la carpe blanche), iler (le forgeron ailé) et youfouf (le pageot). Achetés séparément, ce serait six cartons de 5 kg — trente kilos, et un congélateur entier. Là, c'est dix kilos, et chaque plat de la semaine change de poisson.",
